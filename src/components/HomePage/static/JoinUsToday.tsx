...
const JoinUsToday = () => {
    return (
        <section className='p-3  flex flex-col-reverse xl:flex-row  ms-[20px] xl:ms-[40px] md:ms-[30px]  mt-[80px]  xl:h-[280px]'>
            ...
            <div className=' bg-[#093e4d] w-full xl:w-4/6 rounded-tl-[60px] xl:rounded-tl-[0px] h-[360px] xl:h-[unset] flex justify-center flex-col pl-[70px]'   >
                ...
                <div className='flex gap-3 mt-3 flex-col sm:flex-row w-1/2'>
